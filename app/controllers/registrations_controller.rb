class RegistrationsController < ApplicationController
  ...
  def index
    ...
    @registrations = @q.result(distinct: true)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @registration.save
        format.html { redirect_to @registration, notice: "ルーム情報を登録しました" }
  ...
  def update
    respond_to do |format|
      if @registration.update(registration_params)
        format.html { redirect_to @registration, notice: "ルーム情報を更新しました" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to registrations_url, notice: "ルーム情報を削除しました" }
  ...
  private
    ...
    def registration_params
      params.require(:registration).permit(:name, :introduction, :price, :address, :image)
    end
end
